...
- **[VoicePrint](https://github.com/seanwinslow28/voiceprint)** — the first project in my "Raising Claude" series where the main goal is to have the machines think like me.
